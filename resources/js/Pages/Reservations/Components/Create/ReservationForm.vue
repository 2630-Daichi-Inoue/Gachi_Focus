...
const endCandidates = computed(() => {
    ...
    const allPossibleEndCandidates = [
        ...props.startCandidates.filter(
            (candidate) => candidate > form.startedAt,
        ),
...
<template>
    <div class="border border-gray-300 bg-white p-4">
        <form @submit.prevent="goToPayment" class="space-y-4">
            <div>
                <div class="mb-4 flex max-w-xs flex-col">
                ...
                <p v-if="page.props.errors.date" class="text-sm text-red-600">
                ...
                <div
                    class="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4"
                >
                ...
                <p
                    v-if="page.props.errors.started_at"
                ...
                <p
                    v-if="page.props.errors.ended_at"
                    class="text-sm text-red-600"
                >
            ...
            >
                ...
                <button
                    type="submit"
                    class="ixtems-center flex justify-center rounded border border-gray-500 bg-cyan-600 p-2 text-3xl font-bold text-white transition hover:bg-cyan-700 md:w-3/4"
                >
                    Continue to Payment
                </button>
            </div>
            <div v-else>
                <p class="text-sm text-red-600">
                    Sorry, but we have no available time slots for today.
                </p>
            </div>
        </form>
    </div>
