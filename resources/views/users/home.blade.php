...
<form method="GET" action="{{ route('search') }}" id="searchForm">
    <div class="row mb-2">
        ...
        <div class="col-md-2 mb-2">
            <a href="{{ route('index') }}" class="bg-secondary-subtle border border-dark rounded px-3 py-1 d-inline-block text-center text-dark text-decoration-none w-100">
                Clear Filters
            </a>
        </div>
        ...
        <div class="col-md-2 mb-2">
            <button type="submit" class="border border-dark rounded px-3 py-1 text-white fw-bold w-100" style="background-color: #757B9D; letter-spacing: 0.15em;">Search</button>
        </div>
    </div>
