        ...
        @forelse ($reservations as $reservation)
            <div class="row align-items-center py-4 border-bottom text-center">
                ...
                <div class="col-md-5 d-flex text-md-start align-items-start">
                    <img
                        src="{{ $reservation->space?->display_image_url ?? asset('images/no-image.png') }}"
                ...
                <div class="col-md-2 d-flex flex-column align-items-center justify-content-center">
                    <!-- Rebook -->
                    <form action="{{ route('reservations.rebook', ['id' => $reservation->id]) }}" method="GET" class="mb-2">
                        <button type="submit"
                                style="background-color:rgba(77,124,101,1); color:white; border:none; border-radius:6px;
                                       padding:2px 0; width:140px; height:30px; font-size:0.85rem; font-weight:500;">
                            Rebook
                        </button>
                    </form>
